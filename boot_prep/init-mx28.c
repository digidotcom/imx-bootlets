...
#if !defined(BOARD_CPX2) && !defined(BOARD_CCARDIMX28JS) && !defined(BOARD_WR21)
...
void DDR2EmiController_EDE1116_200MHz(void)
{
...
#if !defined(BOARD_CPX2) && !defined(BOARD_CCARDIMX28JS)
	...
	DRAM_REG[42] = 0x0035b408;
	DRAM_REG[43] = 0x031505f9;
#elif defined(BOARD_WR21)
	DRAM_REG[41] = 0x0002030b;
	DRAM_REG[42] = 0x0036b008;
	DRAM_REG[43] = 0x031a030c;
#else
