...
#elif defined(BOARD_CPX2)
#define	MACHINE_ID	3419
#elif defined(BOARD_WR21)
#define	MACHINE_ID	3737
#elif defined(BOARD_CCARDIMX28JS)
#define	MACHINE_ID	9985
#else
...
#elif defined(BOARD_CCARDIMX28)
#define SDRAM_SIZE	0x08000000	/* 128 MB (minimum) */
#elif defined(BOARD_WR21)
#define SDRAM_SIZE	0x08000000
#endif
